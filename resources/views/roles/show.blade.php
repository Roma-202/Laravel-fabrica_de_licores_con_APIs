@extends('layouts.main', ['title' => __('Detalles del rol')])

@section('content')

    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center"
        style="background-image: url({{ asset('/img/theme/roles-ver.jpg') }}); background-size: cover; background-position: center top;">
        <!-- Mask -->
        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-md-12 {{ $class ?? '' }}">
                    <h2 class="display-2 text-white">Role</h2>
                        <p class="text-white mt-0 mb-5">Vista detallada del rol {{ $role->name }}</p>
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body text-center" style="padding-top: 10rem;">
                        <div class="mb-3">
                            ...
                            <div class="text-muted mb-1">{{ $role->guard_name }}</div>
